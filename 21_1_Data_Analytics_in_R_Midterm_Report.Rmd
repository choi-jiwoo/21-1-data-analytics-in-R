...
코로나19는 대면 서비스업을 직업으로 하는 수많은 사람들에게 경제적 피해를 일으켰습니다. 그중 자영업자들의 피해가 가장 크게 나타나고 있습니다.

감성 분석을 한 결과 코로나19 이전에도 자영업/소상공인에 관한 국민 청원 게시글의 감성은 상당히 부정적이었습니다. 하지만 코로나19 이후 사회적 거리두기, 5인 이상 사적 모임 금지, 영업 시간 단축과 같은 여러 행정 조치들로 인해 자영업자들은 이전 보다 더욱 어려움을 호소하고 있고 이는 청와대 국민 청원 게시판의 코로나19 전과 후로 '자영업/소상공인' 키워드로 검색된 게시글들의 감성 점수 차이의 검정 결과를 통해 확인할 수 있었습니다. 